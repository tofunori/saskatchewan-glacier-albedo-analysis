...
// Load your existing glacier mask
...
print('Area (sq km):', glacier_mask.geometry().area().divide(1000000));
...
var glacier_area = glacier_mask.geometry().area();
var bbox_area = bbox.area();
